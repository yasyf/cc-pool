	...
	cases := map[string]struct {
		...
		"pool session": {
			buf: procargs2(2,
				...
				[]string{"FOO=bar", "CLAUDE_CONFIG_DIR=/Users/me/.cc-pool/config/00000000000000000000000000000001", "PATH=/usr/bin"}),
			wantArgv0:  "/Users/me/.local/bin/claude",
			wantCfgDir: "/Users/me/.cc-pool/config/00000000000000000000000000000001",
		},
		...
		"non-claude node child carries CLAUDE_CONFIG_DIR": {
			buf: procargs2(3,
				...
				[]string{"CLAUDE_CONFIG_DIR=/Users/me/.cc-pool/config/00000000000000000000000000000003"}),
			wantArgv0:  "/usr/bin/node",
			wantCfgDir: "/Users/me/.cc-pool/config/00000000000000000000000000000003",
		},
		"no env block": {
...
func TestScan(t *testing.T) {
	...
	args := map[int][]byte{
		501: procargs2(1, "/Users/me/.local/bin/claude", []string{"/Users/me/.local/bin/claude"},
			[]string{"CLAUDE_CONFIG_DIR=/Users/me/.cc-pool/config/00000000000000000000000000000001"}),
		...
		888: procargs2(3, "/opt/homebrew/bin/fish", []string{"fish", "-c", "claude"},
			[]string{"CLAUDE_CONFIG_DIR=/Users/me/.cc-pool/config/00000000000000000000000000000002"}),
	...
	if byPID[501].ConfigDir != "/Users/me/.cc-pool/config/00000000000000000000000000000001" {
...
func TestCountByConfigDir(t *testing.T) {
	sessions := []Session{
		{PID: 501, ConfigDir: "/Users/me/.cc-pool/config/00000000000000000000000000000001"},
		{PID: 777, ConfigDir: ""},
	...
	cases := map[string]struct {
		...
		"exact match":           {"/Users/me/.cc-pool/config/00000000000000000000000000000001", 1},
		"no sessions for dir":   {"/Users/me/.cc-pool/config/00000000000000000000000000000099", 0},
