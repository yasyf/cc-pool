...
func TestLabelForEmail(t *testing.T) {
	cases := []struct {
		...
		{"org claude token adds numeric suffix", "yasyf-claude-10@yasyf.com", "Yasyf-10"},
		{"org claude token without suffix", "yasyf-claude@yasyf.com", "Yasyf"},
		{"org claude token only", "claude@yasyf.com", "Yasyf"},
		{"org leading claude token", "claude-2@yasyf.com", "Yasyf-2"},
		{"org dotted claude token", "rebecca.claude.fang@ucsf.edu", "UCSF-Rebecca-Fang"},
		{"hyphenated org claude token", "claude-10@e-corp.com", "E-Corp-10"},
		{"hyphenated org base merges segment by segment", "e-corp-claude-10@e-corp.com", "E-Corp-10"},
		{"lone base segment merges too", "corp-claude-2@e-corp.com", "E-Corp-2"},
		{"org multiple numeric suffixes", "yasyf-claude-10-2@yasyf.com", "Yasyf-10-2"},
		{"org plus tag stripped", "yasyf.claude+work@yasyf.com", "Yasyf"},
		{"org claude token case-insensitive", "YASYF-Claude-10@yasyf.com", "Yasyf-10"},
		{"org without claude token unchanged", "yasyf-10@yasyf.com", "Yasyf"},
		{"org claude substring unchanged", "claudette@yasyf.com", "Yasyf"},
		{"consumer claude token adds numeric suffix", "yasyf-claude-10@gmail.com", "yasyf-10"},
		{"consumer claude token without suffix", "yasyf-claude@gmail.com", "yasyf"},
		{"consumer leading claude token", "claude-yasyf@gmail.com", "yasyf"},
		{"consumer claude token only stays verbatim", "claude@gmail.com", "claude"},
		{"consumer claude substring unchanged", "claudette@gmail.com", "claudette"},
		{"consumer claude with digits unchanged", "claude10@gmail.com", "claude10"},
		{"consumer dotted claude token", "a.claude.b@gmail.com", "a.b"},
		{"consumer underscored claude token", "a_claude_b@gmail.com", "a_b"},
		{"consumer mixed separators kept", "a-claude.10@gmail.com", "a.10"},
		{"consumer claude token case-insensitive", "yasyf.Claude@gmail.com", "yasyf"},
		{"consumer plus tag stripped", "yasyf-claude+tag@gmail.com", "yasyf"},
		{"claude token only in plus tag", "user+claude@gmail.com", "user"},
		{"consumer all claude tokens stay verbatim", "claude.claude@gmail.com", "claude.claude"},
	}
