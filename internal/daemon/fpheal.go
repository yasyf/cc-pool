...
// domain. It is keyed by the account ConfigDir.
...
// the wedge lane and recovery ladder; a wedged verdict strikes the debounce.
// Also drives the select-time and standalone-test paths.
